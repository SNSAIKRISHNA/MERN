...
export default function Recipe({ content }) {
  // If the AI returns markdown or plain text, render it here.
  // We use `whiteSpace: "pre-wrap"` so newlines are preserved and
  // markdown-like formatting remains readable. For full markdown
  // rendering you can add a markdown library (e.g., marked) later.
  if (content) {
    return (
      <section>
        <h2>FoodieFriend Recommends:</h2>
        <article
  ...
  // Fallback static recipe (your original content)
  return (
    <section>
      <h2>FoodieFriend Recommends:</h2>
      <article className="suggested-recipe-container" aria-live="polite">
        <p>
          ...
          a simple a delicious <strong>Beef Bolognese Pasta</strong>. Here is the
          recipe:
        </p>
